// SNS 브랜드 아이콘 — lucide-react 1.x에서 빠진 브랜드 아이콘 직접 SVG
...
export function TikTokIcon({ size = 16, className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V8.94a6.34 6.34 0 0 0-.79-.05A6.34 6.34 0 0 0 3.15 15.2a6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.34-6.34V8.72a8.27 8.27 0 0 0 4.76 1.5V6.81a4.85 4.85 0 0 1-1-.12z" />
    </svg>
  );
}
